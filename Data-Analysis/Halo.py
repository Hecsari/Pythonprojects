...
k=ap[(ap.plx>0) & (ap.plx_e/ap.plx<=0.4) & (np.sqrt(ap.X*ap.X+ap.Y*ap.Y)<20000) & (np.sqrt(ap.X*ap.X+ap.Y*ap.Y)>5000) & (np.abs(ap.Z)<20000) & (np.abs(ap.Z)>5000) & (np.abs(ap.FE_H)<5) & (np.abs(ap.O_FE)<5) & (np.abs(ap.MG_FE)<5)]
...
plt.figure(1)
hb= plt.hexbin(k['X'], k['Y'], gridsize=50, cmap='plasma')
cb = plt.colorbar(hb)
cb.set_label('Stars')
plt.xlabel(r'$X\,\,\,[pc]$')
plt.ylabel(r'$Y\,\,\,[pc]$')
plt.savefig('Halo_X_Y.png')

plt.figure(2)
hb= plt.hexbin(k['X'], k['Z'], gridsize=50, cmap='plasma')
cb = plt.colorbar(hb)
cb.set_label('Stars')
plt.xlabel(r'$X\,\,\,[pc]$')
plt.ylabel(r'$Z\,\,\,[pc]$')
plt.savefig('Halo_X_Z.png')

plt.figure(3)
hb= plt.hexbin(k['Y'], k['Z'], gridsize=50, cmap='plasma')
cb = plt.colorbar(hb)
cb.set_label('Stars')
plt.xlabel(r'$Y\,\,\,[pc]$')
plt.ylabel(r'$Z\,\,\,[pc]$')
plt.savefig('Halo_Y_Z.png')

plt.figure(4)
hb= plt.hexbin(k['U'], k['V'], gridsize=30, cmap='plasma')
cb = plt.colorbar(hb)
cb.set_label('Stars')
plt.xlabel(r'$U\,\,\,[\frac{km}{s}]$')
plt.ylabel(r'$V\,\,\,[\frac{km}{s}]$')
plt.savefig('Halo_U_V.png')

plt.figure(5)
hb= plt.hexbin(k['U'], k['W'], gridsize=30, cmap='plasma')
cb = plt.colorbar(hb)
cb.set_label('Stars')
plt.xlabel(r'$U\,\,\,[\frac{km}{s}]$')
plt.ylabel(r'$W\,\,\,[\frac{km}{s}]$')
plt.savefig('Halo_U_W.png')

plt.figure(6)
hb= plt.hexbin(k['V'], k['W'], gridsize=30, cmap='plasma')
cb = plt.colorbar(hb)
cb.set_label('Stars')
plt.xlabel(r'$V\,\,\,[\frac{km}{s}]$')
plt.ylabel(r'$W\,\,\,[\frac{km}{s}]$')
plt.savefig('Halo_V_W.png')

plt.figure(7)
hb= plt.hexbin(k['M_H'], k['ALPHA_M'], gridsize=50, cmap='plasma')
cb = plt.colorbar(hb)
cb.set_label('Stars')
plt.xlabel(r'$[M/H]$')
plt.ylabel(r'$[\alpha/H]$')
plt.savefig('Halo_MH_Alpha.png')

plt.figure(8)
hb= plt.hexbin(k['FE_H'], k['O_FE'], gridsize=50, cmap='plasma')
cb = plt.colorbar(hb)
cb.set_label('Stars')
plt.xlabel(r'$[Fe/H]$')
plt.ylabel(r'$[O/Fe]$')
plt.savefig('Halo_Fe_O.png')

plt.figure(9)
hb= plt.hexbin(k['FE_H'], k['MG_FE'], gridsize=50, cmap='plasma')
cb = plt.colorbar(hb)
cb.set_label('Stars')
plt.xlabel(r'$[Fe/H]$')
plt.ylabel(r'$[Mg/Fe]$')
plt.savefig('Halo_MG_FE.png')
