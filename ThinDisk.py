...
plt.savefig('Thin_Disk_MH_Alpha.png')
...
plt.xlabel(r'$[Fe/H]$')
plt.ylabel(r'$[O/Fe]$')
plt.savefig('Thin_Disk_Fe_O.png')
...
plt.xlabel(r'$[Fe/H]$')
plt.ylabel(r'$[Mg/Fe]$')
plt.savefig('Thin_Disk_MG_FE.png')
...
plt.xlabel(r'$R\,\,[pc]$')
plt.ylabel(r'$[M/H]$')
plt.savefig('Thin_Disk_MH_R.png')
...
plt.savefig('Thin_Disk_Alpha_R.png')
